...
![2_create_new_freeform_prompt_with_variable_1](images/2_create_new_freeform_prompt_with_variabl_1_.png)

3. Save the prompt as a prompt template.
![3_save_prompt_template_1](images/3_save_prompt_template_1.png)

4. Promote asset to deployment space.
![4_promote_to_space_1](images/4_promote_to_space_1.png)

5. Deploy asset in deployment space.
![7_deploy_promoted_asset_1](images/7_deploy_promoted_asset_1.png)

6. Note down the deployment ID. We will need this in OpenPages.
![9_deployed_prompt_template_1](images/9_deployed_prompt_template_1.png)
